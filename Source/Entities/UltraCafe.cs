...
[CustomEntity("FemtoHelper/UltraCafe")]
public class UltraDashTutorialMachine : JumpThru
{
	...
	private UltraDashPresentation presentation;
	...
	public UltraDashTutorialMachine(Vector2 position)
		: base(position, 88, safe: true)
	{
		base.Tag = Tags.TransitionUpdate;
		base.Depth = 1000;
		base.Hitbox.Position = new Vector2(-41f, -59f);
		Add(backSprite = new Image(GFX.Game["objects/FemtoHelper/wavedashtutorial/building_back"]));
		backSprite.JustifyOrigin(0.5f, 1f);
		Add(noise = new Sprite(GFX.Game, "objects/FemtoHelper/wavedashtutorial/noise"));
		noise.AddLoop("static", "", 0.05f);
		noise.Play("static");
		noise.CenterOrigin();
		noise.Position = new Vector2(0f, -30f);
		noise.Color = Color.White * 0.5f;
		Add(frontLeftSprite = new Image(GFX.Game["objects/FemtoHelper/wavedashtutorial/building_front_left"]));
	...
	public UltraDashTutorialMachine(EntityData data, Vector2 position)
	...
	public override void Added(Scene scene)
	{
		...
		frontEntity.Add(frontRightSprite = new Image(GFX.Game["objects/FemtoHelper/wavedashtutorial/building_front_right"]));
		frontRightSprite.JustifyOrigin(0.5f, 1f);
		frontEntity.Add(neon = new Sprite(GFX.Game, "objects/FemtoHelper/wavedashtutorial/neon_"));
	...
	private IEnumerator InteractRoutine(Player player)
	{
		...
		presentation = new UltraDashPresentation(usingSfx);
